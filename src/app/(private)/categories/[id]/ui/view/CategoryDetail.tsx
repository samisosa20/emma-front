            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left border-collapse">
                ...
                <tbody>
                  {listMovements?.map(
                    (
                      movement: GetApiMovements200ContentItem,
                      index: number,
                    ) => (
                      <tr
                        key={movement.id}
                      ...
                      >
                        <td className="p-wf-md font-wf-body-regular text-wf-on-surface whitespace-nowrap">
                          {format(
                        ...
                        <td className="p-wf-md font-wf-body-regular text-wf-on-surface">
                          {movement.description}
                        </td>
                        <td
                          className={`p-wf-md text-right font-wf-body-regular font-semibold ${Number(movement.amount) > 0 ? "text-wf-secondary" : "text-wf-error"}`}
                        >
                  ...
                  {listMovements?.length === 0 && (
                    <tr>
                      <td
                        colSpan={4}
                        className="p-wf-md text-center text-wf-on-surface-variant"
                      >
                        Sin movimientos
                      </td>
                    </tr>
